...
public class SenderController {
    ...
    private void receiveMessage(String message) {
        Platform.runLater(() -> {
                ...
                HBox messageBox = createMessageBubble("Receiver: " + message, Pos.BASELINE_LEFT, Color.LIGHTGRAY);
    ...
    private void sendMessage() {
        ...
        if (!message.isEmpty()) {
            ...
            client.sendMessage("Moi:" + message); // Ajouter "Moi:" pour identifier l'expéditeur
